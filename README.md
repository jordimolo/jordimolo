...
Most of my projects start as university assignments and end up turning into something I actually want to keep improving — a data model for a streaming platform, a bot that plays Hex, a small robot that reacts to your voice. I like picking up whatever a project needs, from setting up a database to wiring a sensor, and I've learned almost as much from coordinating a team (as Scrum Master or Product Owner) as from writing the code itself.
 
* 🌍  I'm based in Barcelona
* 🖥️  See my portfolio at [jordimolo.github.io](https://jordimolo.github.io)
* ✉️  You can contact me at [20.jordiml.02@gmail.com](mailto:20.jordiml.02@gmail.com)
